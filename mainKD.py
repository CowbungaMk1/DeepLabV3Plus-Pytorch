...
def get_argparser():
    ...
    parser.add_argument("--teacher_ckpt", default='./checkpoints/best_deeplabv3plus_resnet101_cityscapes_os16.pth', type=str,
...
def main():
    ...
    teacher_model = network.modeling.__dict__['deeplabv3plus_resnet101'](num_classes=opts.num_classes, output_stride=opts.output_stride)
    ...
    # Will be using distillation losses
    # Set up criterion
    ...
    while not opts.test_only:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            loss = criterion(student_logits, labels) * soft_targets_loss * soft_target_loss_weight * ce_loss_weight
            loss.backward()
            optimizer.step()
